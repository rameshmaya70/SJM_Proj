    ...
    Instafeed = (function () {
        ...
        Instafeed.prototype.parse = function (response) {
            ...
            if ((typeof document !== "undefined" && document !== null) && this.options.mock === false) {
                var cont = $('#' + this.options.target);
                // Clear the content
                cont.html('<ul></ul>');
                images = response.data;

                if (images.length < this.options.limit)
                    this.options.limit = images.length;

                for (var i = 0; i < this.options.limit; i++) {
                    image = images[i];
                    cont.find('ul').append('<li style="float:left;"><a href="' + image.images['standard_resolution'].url + '"><img src="' + image.images[this.options.resolution].url + '"/></a></li>');
                }

                cont.find('li a[href]').photoSwipe({ enableMouseWheel: false, enableKeyboard: false });
