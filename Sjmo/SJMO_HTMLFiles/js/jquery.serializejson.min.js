(function(e) {
    ...
    e.fn.serializeJSON = function(t) {
        ...
        u = o.optsWithDefaults(t);
        n = {};
        e.each(r, function(e, t) {
            i = o.splitInputNameIntoKeysArray(t.name);
            s = o.parseValue(t.value, u);
            if (u.parseWithFunction) s = u.parseWithFunction(s);
            o.deepSet(n, i, s, u)
        });
        return n
    };
    e.serializeJSON = {
        ...
        optsWithDefaults: function(t) {
            ...
            if (t == null) t = {};
            n = e.serializeJSON;
            r = n.optWithDefaults("parseAll", t);
            return {
                parseNumbers: r || n.optWithDefaults("parseNumbers", t),
                parseBooleans: r || n.optWithDefaults("parseBooleans", t),
                parseNulls: r || n.optWithDefaults("parseNulls", t),
        ...
        parseValue: function(t, n) {
            var r, i;
            i = e.serializeJSON;
            if (n.parseNumbers && i.isNumeric(t)) return Number(t);
            if (n.parseBooleans && (t === "true" || t === "false")) return t === "true";
            if (n.parseNulls && t == "null") return null;
            return t
        },
        isObject: function(e) {
            return e === Object(e)
        ...
        splitInputNameIntoKeysArray: function(t) {
            ...
            n = e.map(t.split("["), function(e) {
                r = e[e.length - 1];
                return r === "]" ? e.substring(0, e.length - 1) : e
            });
            if (n[0] === "") {
                n.shift()
            }
        ...
        deepSet: function(t, n, r, i) {
            ...
            if (n.length === 1) {
                ...
                if (s === "") {
                    a = t.length - 1;
                    f = t[a];
                    if (l.isObject(f) && (l.isUndefined(f[o]) || n.length > 2)) {
                        s = a
                    } else {
                        s = a + 1
                    }
